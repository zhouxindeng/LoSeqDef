...
parser.add_argument('--recommendation_scenario', type=str, default='News Recommendation', help='Recommendation scenario')
...
parser.add_argument('--min_epochs', type=int, default=25, help='min epoch')
...
parser.add_argument('--lct_start', type=int, default=0, help='Which epoch of LCT begins')
...
if torch.backends.mps.is_built() and args.use_gpu:
