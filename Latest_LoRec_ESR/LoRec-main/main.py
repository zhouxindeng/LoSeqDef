...
def main(seed=2023, main_file=""):
    ...
    if args.use_LLM:
        path = f"/Users/changliu/Documents/GraduationProject/Latest_LoRec_ESR/LoRec-main/log/{args.model}/{args.LLM}/{args.dataset}/{main_file}/" if main_file != "" else f"/root/tf-logs/lc_LoRec/LoRec-main/log/{args.model}/{args.LLM}/{args.dataset}/"
        if args.with_lct:
            path = f"/Users/changliu/Documents/GraduationProject/Latest_LoRec_ESR/LoRec-main/log/{args.model}/{args.LLM}/{args.dataset}/LCT/{main_file}/" if main_file != "" else f"/root/tf-logs/lc_LoRec/LoRec-main/log/{args.model}/{args.LLM}/{args.dataset}/FD/"
    else:
        path = f"/Users/changliu/Documents/GraduationProject/Latest_LoRec_ESR/LoRec-main/log/{args.model}/No_LLM/{args.dataset}/{main_file}/"  if main_file != "" else f"/root/tf-logs/lc_LoRec/LoRec-main/log/{args.model}/No_LLM/{args.dataset}/"
