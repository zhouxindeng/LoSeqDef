...
parser.add_argument('--model', type=str, default='GRU4rec', help='model')
parser.add_argument('--use_LLM', type=str2bool, default=True, help='training device')

# dataset
parser.add_argument('--dataset', type=str, default='Arts', help='dataset')
...
# model
parser.add_argument('--LLM', type=str, default='Llama2_13', help='LLM model')
parser.add_argument('--LLM_size', type=int, default=5120, help='Output size of LLM')
...
parser.add_argument('--min_epochs', type=int, default=50, help='min epoch')
#parser.add_argument('--n_epochs', type=int, default=100, help='max epoch')
...
#parser.add_argument('--lct_start', type=int, default=20, help='Which epoch of LCT begins')
...
#parser.add_argument('--inject_user', type=str2bool, default=False, help='Whether has injected users in dataset')
parser.add_argument('--inject_persent', type=str, default='bandwagon_1', help='type and presentage of injected user (attack file)')
...
if torch.backends.mps.is_available() and args.use_gpu:
    print('using gpu:{} to train the model'.format(args.device_id))
    args.device_id = list(range(torch.mps.device_count()))
